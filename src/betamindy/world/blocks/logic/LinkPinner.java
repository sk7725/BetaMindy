...
public class LinkPinner extends Block {
    ...
    public class LinkPinnerBuild extends Building implements PushReact {
        ...
        public void drawLink(LogicLink l) {
            ...
            if (build != null)
                Drawf.square(build.x, build.y, build.block.size * tilesize / 2f + 1f, l.active ? Pal.place : Pal.darkerGray);
            else
                Drawf.square(l.x * tilesize, l.y * tilesize, tilesize / 2f + 1f, l.active ? Pal.place : Pal.darkerGray);
        }
