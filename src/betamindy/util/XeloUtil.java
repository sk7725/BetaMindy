...
public class XeloUtil {
    ...
    public boolean pushable(Building build) {
        if (build.dead || (build.block instanceof CoreBlock) || (build.block instanceof PistonArm) || ((build.block instanceof Piston) && ((Piston.PistonBuild) build).extended))
            return false;
        return true;
    }
    ...
    */
    ...
    public @Nullable
    Seq<Building> _getAllContacted(Building root, int direction, int max, Boolf<Building> bool, Boolf<Building> bool2) {
